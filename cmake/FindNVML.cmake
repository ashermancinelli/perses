# Most of this was taken from NVTOP
# https://github.com/Syllo/nvtop/blob/master/cmake/modules/FindNVML.cmake

# Version 1.2
# Public Domain
# Written by Maxime SCHMITT <maxime.schmitt@etu.unistra.fr>
# Extended by Asher Mancinelli <asher.mancinelli@pnnl.gov>
...
#   - NVML::NVML        - Interface target for nvml                           #
#                                                                             #
#/////////////////////////////////////////////////////////////////////////////#
...
add_library(NVML_NVML INTERFACE)
target_include_directories(NVML_NVML INTERFACE ${NVML_INCLUDE_DIRS})
target_link_libraries(NVML_NVML INTERFACE ${NVML_LIBRARIES})
add_library(NVML::NVML ALIAS NVML_NVML)
